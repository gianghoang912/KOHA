...
<xsl:stylesheet version="1.0"
  ...
  exclude-result-prefixes="marc items">
    ...
    <xsl:variable name="TracingQuotesRight">
      <xsl:choose>
        ...
        <xsl:variable name="materialTypeLabel">
            <xsl:choose>
                <xsl:when test="$leader19='a'">Bộ</xsl:when>
                <xsl:when test="$leader6='a'">
                    <xsl:choose>
                        <xsl:when test="$leader7='c' or $leader7='d' or $leader7='m'">Sách</xsl:when>
                        <xsl:when test="$leader7='i' or $leader7='s'">
                            <xsl:choose>
                                <xsl:when test="substring($controlField008,22,1)!='m'">Continuing Resource</xsl:when>
                                <xsl:otherwise>ÂPĐK</xsl:otherwise>
                            </xsl:choose>
                        </xsl:when>
                        <xsl:when test="$leader7='a' or $leader7='b'">Báo</xsl:when>
                    </xsl:choose>
                </xsl:when>
                <xsl:when test="$leader6='t'">Sách</xsl:when>
				<xsl:when test="$leader6='o'">Bộ công cụ</xsl:when>
                <xsl:when test="$leader6='p'">Mixed materials</xsl:when>
                <xsl:when test="$leader6='m'">Tệp tin</xsl:when>
                <xsl:when test="$leader6='e' or $leader6='f'">Bản đồ</xsl:when>
                <xsl:when test="$leader6='g' or $leader6='k' or $leader6='r'">Visual material</xsl:when>
                <xsl:when test="$leader6='j'">Âm nhạc</xsl:when>
                <xsl:when test="$leader6='i'">Âm thanh</xsl:when>
        ...
        <xsl:variable name="schemaOrgType">
            <xsl:choose>
                <xsl:when test="$materialTypeLabel='Book'">Sách</xsl:when>
                <xsl:when test="$materialTypeLabel='Map'">Bản đồ</xsl:when>
                <xsl:when test="$materialTypeLabel='Music'">Album âm nhạc</xsl:when>
        ...
        <h1 class="title" id="kohabooktitle" property="name">
   ...
   <xsl:if test="$DisplayOPACiconsXSLT!='0'">
        ...
        <span class="results_summary type"><span class="label">Kiểu tài liệu: </span>
        ...
        <xsl:if test="$display880">
            <xsl:call-template name="m880Select">
                ...
                <xsl:with-param name="label">Tùng thư: </xsl:with-param>
        ...
        <span class="results_summary series"><span class="label">Tùng thư: </span>
        <!-- 440 -->
        ...
        <span class="results_summary analytics"><span class="label">Tài liệu chủ: </span>
            <a>
            <xsl:choose>
            ...
            <xsl:text>Hiển thị tài liệu chủ</xsl:text>
            </a>
        </span>
        </xsl:if>
        ...
        <span class="results_summary volumes"><span class="label">Tập: </span>
            <a>
            <xsl:choose>
            <xsl:when test="$UseControlNumber = '1' and marc:controlfield[@tag=001]">
            ...
            <xsl:text>Hiển thị tập</xsl:text>
            </a>
        </span>
        </xsl:if>
        ...
        <span class="results_summary set"><span class="label">Bộ: </span>
        ...
        <xsl:if test="$display880">
            <xsl:call-template name="m880Select">
                ...
                <xsl:with-param name="label">Xuất bản: </xsl:with-param>
            </xsl:call-template>
        </xsl:if>
        ...
        <span class="results_summary publisher"><span class="label">Xuất bản: </span>
        ...
        <xsl:if test="$display880">
            <xsl:call-template name="m880Select">
                ...
                <xsl:with-param name="label">Ấn bản: </xsl:with-param>
            </xsl:call-template>
        </xsl:if>

        <xsl:if test="marc:datafield[@tag=250]">
        <span class="results_summary edition"><span class="label">Ấn bản: </span>
        ...
        <xsl:if test="$display880">
            <xsl:call-template name="m880Select">
                ...
                <xsl:with-param name="label">Mô tả vật lý: </xsl:with-param>
            </xsl:call-template>
        </xsl:if>

        <xsl:if test="marc:datafield[@tag=300]">
        <span class="results_summary description"><span class="label">Mô tả vật lý: </span>
        ...
        <xsl:if test="marc:datafield[@tag=020]/marc:subfield[@code='a']">
          <span class="results_summary isbn"><span class="label">Số ISBN: </span>
        ...
        <xsl:if test="marc:datafield[@tag=022]/marc:subfield[@code='a']">
          <span class="results_summary issn"><span class="label">Số ISSN: </span>
        ...
        <xsl:if test="marc:datafield[@tag=013]">
            <span class="results_summary patent_info">
                <span class="label">Thông tin tập: </span>
        ...
        <xsl:if test="marc:datafield[@tag=088]">
            <span class="results_summary report_number">
                <span class="label">Số báo cáo: </span>
        ...
        <xsl:if test="$display880">
            <xsl:call-template name="m880Select">
                ...
                <xsl:with-param name="label">Nhan đề song song: </xsl:with-param>
            </xsl:call-template>
        </xsl:if>

        <xsl:if test="marc:datafield[@tag=246]">
        <span class="results_summary other_title"><span class="label">Nhan đề song song: </span>
        ...
        <span class="results_summary translated_title"><span class="label">Nhan đề dịch: </span>
        ...
        <xsl:if test="$display880">
            ...
            <xsl:call-template name="m880Select">
                ...
                <xsl:with-param name="label">Nhan đề đồng nhất: </xsl:with-param>
            </xsl:call-template>
            </span>
        </xsl:if>

        <xsl:if test="marc:datafield[@tag=130]|marc:datafield[@tag=240]|marc:datafield[@tag=730][@ind2!=2]">
        <span class="results_summary uniform_titles"><span class="label">Nhan đề đồng nhất: </span>
        ...
        <xsl:if test="marc:datafield[substring(@tag, 1, 1) = '6']">
            <span class="results_summary subjects"><span class="label">Chủ đề: </span>
...
<!-- Image processing code added here, takes precedence over text links including y3z text   -->
        ...
        <span class="results_summary online_resources"><span class="label">Nguồn trực tuyến: </span>
	    ...
	    <xsl:choose>
	      ...
	      <xsl:otherwise>
            ...
            <xsl:otherwise>
                <xsl:text>Click vào đây để truy cập trực tuyến</xsl:text>
            </xsl:otherwise>
            </xsl:choose>
            </a>
            <xsl:choose>
        ...
        <xsl:if test="position()=1">
            ...
            <xsl:when test="@ind1=2">
                <span class="label">Nội dung tập:</span>
            </xsl:when>
            <xsl:otherwise>
        ...
        <xsl:if test="marc:datafield[@tag=502]">
            <span class="results_summary diss_note">
                <span class="label">Ghi chú luận văn: </span>
        ...
        <xsl:if test="marc:datafield[@tag=866]">
            <span class="results_summary holdings_note"><span class="label">Ghi chú ĐKCB: </span>
        ...
        <span class="results_summary other_editions"><span class="label">Ấn bản khác: </span>
